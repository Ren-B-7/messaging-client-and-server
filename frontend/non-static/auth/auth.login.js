...
const AuthLogin = {
    setup() {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                AuthLogin.showError("username", "Login succeeded but no redirect was provided.");
            } catch (err) {
    ...
    _handleServerError(data) {
        ...
        switch (data.code) {
            ...
            case "USER_BANNED":
                ...
                break;
            case "RATE_LIMITED":
                AuthLogin.showError("username", msg || "Too many attempts. Please wait a moment.");
                break;
            case "MISSING_FIELD":
            case "INVALID_INPUT":
                AuthLogin.showError("username", msg);
     ...
     * @param {string} fieldId  The input element's id (error el is
     *     `${fieldId}Error`)
