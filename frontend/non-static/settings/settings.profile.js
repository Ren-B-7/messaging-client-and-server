...
const SettingsProfile = {
  ...
  _checkChanges(saveBtn) {
    const changed = (document.getElementById("firstName")?.value || "") !==
                        this._original.firstName ||
                    (document.getElementById("lastName")?.value || "") !==
                        this._original.lastName ||
                    (document.getElementById("username")?.value || "") !==
                        this._original.username;
    if (saveBtn)
  ...
  _reset() {
    ...
    const username = document.getElementById("username");
    if (firstName)
      firstName.value = this._original.firstName;
    if (lastName)
      lastName.value = this._original.lastName;
    if (username)
      username.value = this._original.username;
  },
